...
REDACTION_REPORT_PATH = OUTPUT_DIR / "ROE20_FEEDBACK_SECOND_RUN_REDACTION_REPORT.json"
...
def build_redaction_report(findings: list[dict[str, Any]], artifact_count: int) -> dict[str, Any]:
    ...
    return {
        "schema": "ResidualOps_FeedbackSecondRunRedactionReport/v0.1",
...
def scan_feedback_second_run_artifacts(paths: list[Path], write_result: bool = True) -> dict[str, Any]:
    findings: list[dict[str, Any]] = []
    for path in paths:
