...
VERTICAL_ARTIFACTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "package": "AgentSec-3",
        "primary_result": "public_launch/agentsec3/AGENTSEC3_POLICY_GATE_RESULT.json",
        "claim_audit": "public_launch/agentsec3/AGENTSEC_CLAIM_BOUNDARY_AUDIT.json",
        "artifact_paths": [
        ...
        "public_role": "local MCP/tool manifest policy-gate artifact",
    },
    {
